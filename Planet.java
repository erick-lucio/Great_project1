 ...
 *48-57 65-90
 */
public class Planet extends SpaceSize {
    Random rand = new Random();
    
  //  private int type_of_matter_contained ;
    private int have_life ;
    ...
    public int getHave_life() {
        return have_life;
    }

    public void setHave_life(int have_life) {
        this.have_life = have_life;
    }
...
public Planet(){
    ...
    Planet(String starId,String galaxyId,String universeId,Content content1,int xmin1,int ymin1,int xmax1,int ymax1,Content[][] universeXY1){
        //super(positionY,positionX,r,area);           
       // this.name = letters.createRandonNames(10);
        
      

        //this.type_of_matter_contained = 1;
        this.have_life = 0;
        
        
        
//        generatespace();
        //tamanho do planeta e tamanho espaço
    //ERICK TRABSON WITH MICAEL HELP
        //create randon names using class letter
       // System.out.println("Creating  Planet "+this.name+" from Star " + starId +" from Galaxy "+ galaxyId +" from Universe "+ universeId);
       // this.planetQtd++;
    ...
    Planet(String Name){
        this.name=Name;
        do{
            this.mass=rand.nextInt(200000);
        }while(this.mass< 50000);
