 ...
 * @author user
 */
public final class BlackHole extends SpaceSize{
    ...
    public BlackHole(String Name){
        this.name=Name;
         do{
        this.mass=rand.nextInt(50000000);
        }while(this.mass< 10000000);
    }
    BlackHole(){
        //super(positionX,positionY,r,area);
        Letters letters = new Letters();
        this.name = letters.createRandonNames(10);
        this.mass = 55;
      
       
       // System.out.println("ENTRANDO GENERATE SPACE DO BLACK HOLE");
//        generatespace();
        this.gravity_force = (float) 5454.00;
